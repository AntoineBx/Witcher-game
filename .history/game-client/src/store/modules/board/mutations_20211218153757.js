...
export default {
    ...
    [UPDATE_BOARD](state,{board}){
        ...
        state.graveyards[1] = board.deck1;
        state.graveyards[2] = board.deck2;
    ...
    [UPDATE_CARDS](state,{cards}){
        ...
        Object.keys(cards).forEach(cardId => {
            if(state.cardsState[cardId] != undefined){
                // Card found => Update each element in it rather than replacing the entire array (to allow Vue responsiveness on these data)
