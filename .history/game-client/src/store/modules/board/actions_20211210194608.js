...
export default {
    ...
    [USER_UPDATE_SHOWCASE]({commit}, iddcard){
        console.log("updateShowcase ", iddcard);
        commit(UPDATE_SHOWCASE,{idCard : iddcard})
        commit(ADD_CARD_STATUS,{ idCard : iddcard , status:"showcase"})
    },
