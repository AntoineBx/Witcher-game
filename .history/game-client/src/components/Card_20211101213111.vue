    ...
    export default {
        ...
        watch: {
            hidden(){
                ...
                if(this.hidden){
                    ...
                    this.$refs.currentCard.transform = "rotateY(180deg)"
                }else{
                    this.hiddenDegree = 0
                    this.$refs.placeholder.classList.remove('hidden'); 
                    this.$refs.currentCard.transform = "rotateY(0deg)"
                }
            }
        },
        computed: {
        ...
        mounted: function(){
            ...
            this.currentContainer.addEventListener("mouseleave",(event)=> {
                ...
                this.currentCard.style.transform = "scale3d(1,1,1) rotateY("+ (-this.hiddenDegree)+"deg)";
        ...
        methods: {
            ...
            updateTransforms : function(event){
                ...
                let rotateX = -(mousePosX-(this.$data.currentCard.offsetWidth*1.05/2))*0.1 + this.hiddenDegree;
                ...
                console.log(this.hiddenDegree)
                this.$data.currentCard.style.transform = "scale3d(1.15,1.15,1.15)"+"rotateX("+rotateY+this.hiddenDegree+"deg) "+"rotateY("+rotateX+"deg) ";
