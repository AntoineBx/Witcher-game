<template>
    <div class="board">
        ...
        <div ref="handOpponent" @mouseover.stop="hoverHand(false)"  @mouseleave="hoverOutHand(false)" class="hand opponent">
            <Card  cardName="iris"/>
        ...
        <div ref="handPlayer" @mouseover.stop="hoverHand(true)" @mouseleave="hoverOutHand(true)" class="hand player">
            <Card  cardName="iris"/>
