    ...
    export default {
        ...
        watch:{
            '$store.state.board.triggercardsState': function() {
                if( this.$store.state.board.cardsState[this.cardProps.id] == undefined ) return;
                this.StoreLockPosition = this.$store.state.board.cardsState[this.cardProps.id].coord
                this.status = this.$store.state.board.cardsState[this.cardProps.id].status
            },
            ...
            StoreLockPosition(){
                if(this.$refs.currentContainer != undefined){
                    ...
                    console.log(" this.StoreLockPosition.x : ",this.StoreLockPosition.x )
                    let endX = this.StoreLockPosition.x
                    let endY = this.StoreLockPosition.y
                    ...
                    this.$refs.currentContainer.style.transform = "translate("+this.StoreLockPosition.x+"px,"+this.StoreLockPosition.y+"px)"    
                }
            },
            hidden(){
                if(this.hidden){
        ...
        computed: {
            ...
            powerImg : function(){
              return "/src/assets/misc/number/"+this.cardProps.power+".png";
            },
        ...
        created: function(){
            this[UPDATE_CARD_STATE_COORD]({ uuid : this.cardProps.id,coord:{x:0,y:0}})
            this.SetCardData();
