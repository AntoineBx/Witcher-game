...
export default {
    ...
    methods: {
        ...
        setCoord(){
            ...
            if(this.idCard == "" ||this.idCard == undefined){ console.error("placeholder IDCARD undefined ! ");}
            this[UPDATE_CARD_STATE_COORD]({idCard : this.card, coord: { x: ref.getBoundingClientRect().left, y: ref.getBoundingClientRect().top}})
        }
    },
    mounted :function(){
        this.setCoord()
