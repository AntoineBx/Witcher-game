...
import Graveyard from "@/components/Board/graveyard.vue";
...
export default {
    components: { Card, Field, Deck, CardsStack, Hand, ShowcaseCard, BannerTurn, PassedButton, PassedBanner, Graveyard },
    props: {
        hidden : Boolean
    },
    data(){
