<template>
  <div class="popup" :class="delayOpen?'showing':''" @click="close" @contextmenu="close" @keydown.esc="close" tabindex="0">
    <div class="inner-popup" @click="stopClose" @contextmenu="close">
      <Card  :cardName="this.cardName" :cardProps="cardProps" :unmovable="true" :hidden="false" :showcaseCard="true" />
      <div class="card-resume">
        ...
        <div class="description">
          ...
          <div class="separator"> <img src="@/assets/misc/separator.png" Width="80%"/> </div>
          <div class="abilities">
