    ...
    export default {
        ...
        methods: {
            ...
            updateTransforms : function(event){
                ...
                let scale = this.$data.isHolding? 0.8 : 1.15;
                this.$data.currentCard.style.transform = "scale("+scale+")"+"rotateX("+rotateY+this.hiddenDegree+"deg) "+"rotateY("+(rotateX+this.hiddenDegree)+"deg) ";
