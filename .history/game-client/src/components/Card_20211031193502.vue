...
<div class="placeholder" ref="placeholder">
    <div class="card-container" ref="currentContainer">
        <div class="net"/>
        <div class="card" ref="currentCard" @mousedown="triggerHold" @mouseup="triggerRelease" >
            
            <img class="backupImg" :src='urlImgBackup' alt="">
            <div class="video">
                <video ref="videoRef"  id="video-container" @loadedmetadata="onVideoLoad" Width="100%" loop muted></video>
            </div>
            <div class="border"><img src="@/assets/card/border-gold.png" draggable="false" ondragstart="return false;" alt=""></div>
            <div class="glare"><div ref="currentGlare" class="glare-inner"></div></div>
            <div class="top-left">
                <div class="banner"><img src="@/assets/card/banner.png" width="100%"></div>
                <div class="rarity"><img src="@/assets/card/rarity-epic.png" width="100%"></div>
            </div>
    ...
    export default {
        ...
        computed: {
            urlImgBackup: function ()  {
                return  "/src/assets/card/"+this.folderName+"/"+this.folderName+".jpg";
            }
        },
        mounted: function(){
            this.$refs.videoRef.src = "/src/assets/card/"+this.folderName+"/"+this.folderName+".webm";
            ...
            this.currentContainer.addEventListener("mouseenter",(event)=>{
                this.isHover = true;
                this.ticking = false;
                this.currentCard.style.transition =  "transform 0.2s ease-out";
            ...
            this.currentContainer.addEventListener("mouseleave",(event)=> {
                ...
                this.currentCard.style.transition =  "transform 0.5s";
                this.currentCard.style.transform = "scale3d(1,1,1)";
        ...
        methods: {
            ...
            updateTransforms : function(event){
                ...
                if(this.$data.beginToHover == false){//change transition speed after 1sec of entering card
                    this.$data.currentCard.style.transition =  "transform 0.05s";
                }
                this.$data.currentCard.style.transform = "scale3d(1.15,1.15,1.15)"+"rotateX("+rotateY+"deg) "+"rotateY("+rotateX+"deg) ";
