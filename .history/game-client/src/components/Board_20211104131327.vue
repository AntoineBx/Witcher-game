<template>
    <div class="board">
        ...
        <div ref="handOpponent" @mouseover="hoverHand(false)"  @mouseleave="hoverOutHand" class="hand opponent">
            <Card  cardName="iris"/>
        ...
        <div ref="handPlayer" @mouseover="hoverHand(true)" class="hand player">
            <Card  cardName="iris"/>
    ...
    created() {
     ...
     methods: {
        ...
        hoverHand(playerHand){
            if(playerHand){
                this.$refs.handPlayer.style.bottom = "0px"
            }else{
                this.$refs.handPlayer.style.top = "0px"
            }
        },
